...
<section class="columns three-columns">
	...
	<section>
		<h2>Programming</h2>
		<p>Primarily C#, but I also know a couple other and I am looking to learn more</p>
	</section>
	<section>
		<h2>Design</h2>
		<p>Web - CSS, SCSS/Sass, Less</p>
		<p>Occasionally vector graphics using Inkscape</p>
	</section>
	<section>
		<h2>Electronics</h2>
		<p>Mostly a hobby, for fun, but I know a fair bit</p>
	</section>
</section>

<section class="columns two-columns">
	<h1>What I know</h1>
	<section>
		<h2>Languages</h2>
		<ul>
...
<section class="columns three-columns">
	...
	<section>
		<h2><a href="https://github.com/Karl255/NBodySim">NBodySim</a></h2>
		<p>A 2D n-body physics simulator with honestly quite unintuitive controls.</p>
	</section>
	<section>
		<h2><a href="https://github.com/Karl255/YetAnotherTetrisClone">YetAnotherTetrisClone</a></h2>
		<p>The name says everything. A very very simple clone in MonoGame.</p>
	</section>
	<section>
		<h2><a href="https://github.com/Karl255/WeatherFetch">WeatherFetch</a></h2>
	...
	<section>
		<h2><a href="https://github.com/Karl255/ArduinoStaticWebServer">ArduinoStaticWebServer</a></h2>
	...
	<section>
		...
		<p>My attempt at a cycle-accurate, cross-platform NES emulator. Doesn't work, don't bother with it. This was my HS graduation project.</p>
	</section>
</section>
